<template>
    <v-container>
        ...
        <v-dialog v-model="dialog" persistent max-width="600px">
            <v-card>
                <v-card-title> <span class="headline">Bengkel Description</span> </v-card-title>
                <v-card-text>
                    <v-container>
                        <v-row>
                            <v-col cols="12">
                            ...
                            <v-col cols="12">
                                <v-text-field label="Phone*" v-model="form.phoneNumber" required></v-text-field>
                            </v-col>
                            <v-col cols="12">
...
export default {
    ...
    methods: {
        ...
        sendData() {
            ...
            this.user.append('created_att', this.form.created_at);
            var uri = this.$apiUrl + '/bengkel'
            this.load = true 
        ...
        editHandler(item){ 
            ...
            this.form.created_att = item.created_at;
            this.updatedId = item.id 
        },

        deleteData(deleteId){ //mengahapus data 
            var uri = this.$apiUrl + '/bengkel/' + deleteId; //data dihapus berdasarkan id 
